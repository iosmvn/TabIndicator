...
//  ECustomer
//
//  Created by 孙丹龙 on 15/7/1.
//  Copyright (c) 2015年 daniel.sun. All rights reserved.
//
...
@interface TabIndicatorView : UIView <UIScrollViewDelegate> {
    ...
    __weak id<TabIndicatorDelegate> _slideSwitchViewDelegate;
}
...
@property (nonatomic, weak) id<TabIndicatorDelegate> delegate;
...
@protocol TabIndicatorDelegate <NSObject>
 ...
 * @result tab个数
 */
- (NSUInteger)numberOfTab:(TabIndicatorView *)view;
 ...
 */
- (UIViewController *)slideSwitchView:(TabIndicatorView *)view viewOfTab:(NSUInteger)number;
 ...
 * @result
 */
- (void)slideSwitchView:(TabIndicatorView *)view panLeftEdge:(UIPanGestureRecognizer*) panParam;
 ...
 * @result
 */
- (void)slideSwitchView:(TabIndicatorView *)view panRightEdge:(UIPanGestureRecognizer*) panParam;
 ...
 * @result
 */
- (void)slideSwitchView:(TabIndicatorView *)view didselectTab:(NSUInteger)number;
